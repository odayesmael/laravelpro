					...
					<div class="standard__blog__post">
						...
						<div class="standard__blog__content">
							<div class="blog__post__avatar">
								<div class="thumb"><img src="{{(!empty($post->user->profile_image))? url('upload/admin_images/'.$post->user->profile_image) : url('upload/no_image.jpg')}}" alt=""></div>
								<span class="post__by">By : <a href="">{{$post->user->name}}</a></span>
							</div>
