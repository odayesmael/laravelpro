                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('store.profile') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="profile_image" type="file" value="{{$editData->profile_image}}" id="image">
                            </div>
                        </div>
                        <!-- end row -->
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <img class="rounded avatar-lg" id="ShowImage" src="{{(!empty($editData->profile_image))? url('upload/admin_images/'.$editData->profile_image):url('upload/no_image.jpg') }}
